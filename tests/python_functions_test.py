...
class TestPythonFunctionPractice(unittest.TestCase):
    ...
    def test_volume_of_cube(self):
        volume_of_cube_with_a_length_of_nine =  volume_of_cube(9)
        self.assertEqual(729, volume_of_cube_with_a_length_of_nine)

    #Given a String, return the String reversed
    def test_reverse_string(self):
        reversed_text = "Happy days!"[::-1]
        self.assertEqual("!syad yppaH", reversed_text)

    #Given a value in farenheit, convert this into celsius.
    def test_fahrenheit_to_celsius(self):
        return_celsius = fahrenheit_to_celsius(32)
        self.assertEqual(0, return_celsius)
